...
func newInstallCmd() *cobra.Command {
	...
	cmd.Flags().BoolVar(&opt.Force, "force", false, "if a different-scope install already exists, uninstall it first instead of aborting (a system-scope install cannot be removed without root: install then proceeds with a warning and prints the cleanup command)")
